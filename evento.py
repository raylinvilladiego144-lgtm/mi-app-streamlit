...
class TipoEvento(str, enum.Enum):
    ...
    def _missing_(cls, value):
        # Esta línea evita el LookupError si la DB tiene datos antiguos o basura
        return cls.APORTE_CAJA
...
class EventoFinanciero(Base):
    ...
    # Usamos native_enum=False para máxima compatibilidad con SQLite
    tipo_evento: Mapped[TipoEvento] = mapped_column(SQLEnum(TipoEvento, native_enum=False), nullable=False)
